  ...
  return (
    <section id="contact" className="bg-white py-12 sm:py-16 px-4 sm:px-6 lg:px-8 font-sans border-t border-gray-100">
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        {/* Content Area: Grid Contact Info & Form */}
              ...
              <div className="space-y-5">
                ...
                <div className="flex items-start gap-4 text-left">
                  ...
                  <div className="flex-1 text-left">
                    <h4 className="text-xs font-bold text-gray-400 uppercase tracking-wider leading-none text-left">
                      Alamat Kantor
                    </h4>
                    <p className="text-xs font-semibold text-black mt-1.5 leading-relaxed text-left">
                ...
                <div className="flex items-start gap-4 text-left">
                  ...
                  <div className="flex-1 text-left">
                    ...
                    <p className="text-xs font-semibold text-black mt-1.5 text-left">
                      +62 812-3456-7890
                    </p>
                  </div>
                </div>
